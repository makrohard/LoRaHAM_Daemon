...
require "$DAEMON" "client_slot_broadcast_bytes_queued(io->data_slots" "DATA RX broadcast uses RadioChannelIo ClientSlot table"
require "$DAEMON" "daemon_process_radio_band(&radio_controller_433, &channel_433" "433 DATA RX broadcast routed through RadioChannelIo"
require "$DAEMON" "daemon_process_radio_band(&radio_controller_868, &channel_868" "868 DATA RX broadcast routed through RadioChannelIo"
require "$DAEMON" "client_slot_broadcast_queued(io->conf_slots" "CONF broadcasts use RadioChannelIo ClientSlot table"
require "$DAEMON" "daemon_process_cad_status(&radio_controller_433, &channel_433)" "433 CONF broadcasts routed through RadioChannelIo"
require "$DAEMON" "daemon_process_cad_status(&radio_controller_868, &channel_868)" "868 CONF broadcasts routed through RadioChannelIo"
